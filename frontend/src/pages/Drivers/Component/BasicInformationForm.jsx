...
import AssignedVehicleField from './AssignedVehicleField.jsx';
        ...
        <div className="basic-info-outer-container">
          ...
          <div className="basic-info-container">
            <form ref={ref} onSubmit={handleSubmit} className="basic-info-form">
              ...
              {/* Row 3: Location (enterprise scope only) paired with the vehicle
                picker. Inside a location, Location is implied, so the vehicle
                picker sits alone here (Branch Role moved down to Row 4). */}
              <div className="basic-info-form-row">
                {!insideBranch && (
                  <div className="basic-info-form-field">
                ...
                <AssignedVehicleField
                  ...
                  onChange={(v) => handleInputChange('vehicleId', v)}
                />
              </div>

              {/* Row 4: Password paired with the scope's role selector, aligned
                directly below the row above. */}
              <div className="basic-info-form-row">
                <div className="basic-info-form-field">
                  <label className="basic-info-label">Password {!isEdit && '*'}</label>
                  <input
                    type="password"
              ...
              {!isEdit && (
                <div className="basic-info-form-row">
                  <span className="basic-info-hint">
                    * Select at least one role (Enterprise or Branch) to create the employee.
                  </span>
                </div>
              )}
              ...
              {roles.length === 0 && (
                <div className="basic-info-form-row">
                  <span className="basic-info-hint">
                    No roles are available to your enterprise yet. Ask your administrator to enable
                    roles under Workforce → User Management.
                  </span>
                </div>
              )}
            </form>
