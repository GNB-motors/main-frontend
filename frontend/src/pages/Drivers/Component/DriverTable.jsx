...
import { DriversTableSkeleton, ActionMenu } from './DriverMenuExtras.jsx';
              ...
              <tr>
                <td colSpan="6" style={{ textAlign: 'center', color: 'var(--color-grey-400)' }}>
                  {searchTerm
                    ...
                    : 'No drivers found for this business.'}
                </td>
              </tr>
            ) : (
              drivers.map((driver) => (
                    ...
                    <div className="drivers-driver-name-cell">
                      ...
                      <div className="drivers-driver-info">
                        ...
                        <span className="drivers-driver-role">
                          {formatRole(driver.role, driver.is_superadmin)}
                        </span>
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <div className="drivers-status-cell">
                      {driver.branchStatus === 'DEACTIVATED' ? (
                        ...
                        <div
                          className={`drivers-status-badge drivers-status-${(driver.status || 'PENDING').toLowerCase()}`}
                        >
