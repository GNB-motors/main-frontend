...
import { Grid, UserPlus, LogOut, ToggleRight, MessageCircle } from 'lucide-react';
        ...
        >
            <div className="superadmin-sidebar-content">
                ...
                <nav className="superadmin-sidebar-nav">
                    ...
                    <NavLink to="/superadmin/whatsapp" className="superadmin-nav-link" onClick={closeSidebarOnMobile}>
