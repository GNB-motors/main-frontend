    ...
    <section id="cust-demo" data-screen-label="Customer CTA" style={{ background: "#FFFFFF", padding: "112px 40px" }}>
      <div data-reveal style={{ maxWidth: "1280px", margin: "0 auto", borderRadius: "var(--radius-ultra-soft)", background: "linear-gradient(150deg, #2F58EE 0%, #213EA7 100%)", padding: "80px 72px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: "720px" }}>
          <h2 style={{ fontFamily: "var(--font-display)", fontWeight: "700", fontSize: "44px", lineHeight: "1.08", letterSpacing: "-1.6px", color: "#FFFFFF", margin: "0", textWrap: "pretty" }}>One truck is enough to start.</h2>
          <p style={{ fontSize: "18px", lineHeight: "29px", color: "rgba(255,255,255,.84)", margin: "22px 0 36px" }}>No implementation project and no minimum fleet size. Bring your vehicle number and we will set it up on the call.</p>
