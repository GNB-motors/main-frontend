  ...
  return (
    <button
      ...
      style={{
        ...
        transition: 'background 200ms cubic-bezier(.2,0,0,1), opacity 200ms',
      }}
    >
      <svg
        width="18"
...
export default function Testimonials() {
  ...
  return (
    <section
      ...
      style={{ background: '#FFFFFF', padding: '112px 40px', overflow: 'hidden' }}
    >
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        >
          ...
          <div data-tst-arrows style={{ display: 'flex', gap: '10px' }}>
        ...
        <div data-reveal data-tst-track style={{ marginTop: '52px', overflow: 'hidden' }}>
          <div
            data-tst-rail
            style={{
              display: 'flex',
              ...
              transform: `translateX(calc(${-i} * ((100% - 40px) / 2.4 + 20px)))`,
            }}
          >
            {CARDS.map((c, idx) => (
              <div
              ...
              >
                ...
                <div style={{ fontSize: '16px', lineHeight: '26px', color: '#5D5D5E', flex: 1 }}>
                  {c.body}
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  <div style={{ fontSize: '14px', color: '#93939A', marginTop: '3px' }}>
                    {c.org}
                  </div>
                </div>
              </div>
