export default function TrackingCta() {
  return (
    <section id="vt-demo" data-screen-label="Tracking CTA" style={{ background: "#F4F5FA", padding: "104px 40px 96px" }}>
      <div data-reveal style={{ maxWidth: "1280px", margin: "0 auto", borderRadius: "var(--radius-ultra-soft)", background: "linear-gradient(150deg, #2F58EE 0%, #213EA7 100%)", padding: "80px 72px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: "720px" }}>
          <h2 style={{ fontFamily: "var(--font-display)", fontWeight: "700", fontSize: "44px", lineHeight: "1.08", letterSpacing: "-1.6px", color: "#FFFFFF", margin: "0", textWrap: "pretty" }}>See your own trucks on the map.</h2>
          <p style={{ fontSize: "18px", lineHeight: "29px", color: "rgba(255,255,255,.84)", margin: "22px 0 36px" }}>We will put live telemetry from your fleet on screen in the demo, not a sample dataset.</p>
          <div style={{ display: "flex", gap: "14px", flexWrap: "wrap" }}>
            <a href="#vt-demo" style={{ fontFamily: "var(--font-ui)", fontSize: "16px", fontWeight: "600", color: "#213EA7", background: "#FFFFFF", border: "1px solid #FFFFFF", padding: "18px 40px", borderRadius: "999px", transition: "background 200ms cubic-bezier(.2,0,0,1)" }}>Reach us</a>
