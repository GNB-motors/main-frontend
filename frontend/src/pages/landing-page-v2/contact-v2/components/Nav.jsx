    ...
    <div style={{ position: "sticky", top: "0", zIndex: "80", padding: "0 40px", background: "rgba(255,255,255,.92)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(5,8,22,.08)" }}>
      <div style={{ maxWidth: "1280px", margin: "0 auto", display: "flex", alignItems: "center", gap: "26px", height: "78px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px", marginLeft: "14px", fontSize: "14px", color: "#93939A" }}>
          <span>/</span>
          <span style={{ color: "#5D5D5E" }}>Company</span>
          <span>/</span>
          <span style={{ color: "#050816", fontWeight: "500" }}>Contact</span>
        </div>
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "10px" }}>
          <a href="/about" style={{ fontFamily: "var(--font-ui)", fontSize: "15px", fontWeight: "600", color: "#5D5D5E", padding: "11px 18px", whiteSpace: "nowrap" }}>About GNB Edge</a>
          <a href="#contact-form" style={{ fontFamily: "var(--font-ui)", fontSize: "15px", fontWeight: "600", color: "#FFFFFF", background: "var(--nova-rage-400)", border: "1px solid var(--nova-rage-800)", padding: "12px 26px", borderRadius: "999px", whiteSpace: "nowrap", transition: "background 200ms cubic-bezier(.2,0,0,1)" }}>Book a demo</a>
        </div>
      </div>
    </div>
  );
