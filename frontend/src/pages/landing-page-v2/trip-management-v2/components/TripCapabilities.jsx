...
export default function TripCapabilities() {
  return (
    <section
      data-screen-label="Trip capabilities"
    ...
    >
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        >
          ...
          >
            Six jobs on one record, in the order a consignment moves through them.
          </p>
        </div>
        ...
        <div data-reveal-group style={{ borderTop: '1px solid rgba(5,8,22,.10)' }}>
          {ITEMS.map((item) => (
            <div
              ...
              style={{
                display: 'grid',
                gridTemplateColumns: '96px 1fr 1.2fr',
                gap: '32px',
                alignItems: 'start',
                padding: '32px 20px 34px 8px',
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                <span
                  style={{ fontFamily: 'var(--font-mono)', fontSize: '13px', color: '#C0C0C8' }}
                >
                  {item.n}
                </span>
                <span
