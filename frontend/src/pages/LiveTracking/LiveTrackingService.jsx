...
export const LiveTrackingService = {
   ...
   * @param {object} params - { from, to, limit, snap: 'corridor' }
   * @returns {Promise<object>} { registrationNumber, from, to, points,
   *   totalCount, truncated, coveredFrom, coveredTo, snap? } — `snap` is a
   *   display-only corridor-matched path (never persisted, never in stats).
   */
