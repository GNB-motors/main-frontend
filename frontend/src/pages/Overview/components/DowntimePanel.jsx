        ...
        loading && !downtime ? (
          ...
          <div className="text-right">
            <div
              ...
              style={{ color: exposure > 0 ? 'var(--caution)' : 'var(--ok)' }}
            >
